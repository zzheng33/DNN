...
npb_apps =["cg.W.x","cg.S.x","cg.B.x","cg.C.x","ep.W.x","ep.S.x","ep.B.x","ep.C.x","mg.W.x","mg.S.x","mg.B.x","mg.C.x"]
#npb_apps = ["is.S.x","is.W.x","is.A.x","is.B.x","is.C.x","is.D.x"]
# npb_apps=["lu.W.x","lu.S.x","lu.A.x","lu.B.x","lu.C.x","lu.D.x"]
npb_apps=["mg.S.x"]
npb_cores_pack = "16-23,48-55,24-31,56-63"
npb_cores_spread = "0-31"
cores_dist = [npb_cores_pack,npb_cores_spread]

npb_output = "../result/NPB_result/tmp/tmp.csv"
